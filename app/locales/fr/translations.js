export default {
    ...
    errors: {
        ...
        after: "{{description}} doit être aprés {{after}}",
        ...
        otherThan: "{{description}} doit être differents que {{value}}",
        ...
        onOrAfter: '{{description}} doit être maintenant ou apres {{onOrAfter}}',
