...
export default LeosacRoute.extend({
    ...
    {
        "use strict";
        return this.get('store').findRecord('evoxs-access-point', params.access_point_id);
    },
            ...
            this.controller.get('model').save().then(() =>
                {
                    ...
                    this.transitionTo('modules.evoxs.access-point', this.controller.get('model').get('id'));
                },
                () =>
                {
