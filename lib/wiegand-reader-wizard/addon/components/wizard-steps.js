...
const myValidations = buildValidations({
    configName: [
...
export default Ember.Component.extend(myValidations, {
    ...
    init() {
        ...
        console.log(this.get('configName'));
        let steps = [
            {
                value: 'general',
                name: 'Step 1',
...
//             }
//             else {
                this.validate().then(({self, validations}) => {
